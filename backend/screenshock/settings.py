"""
Django settings for screenshock project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-&0e&j#(&%a-zgosvb6-+j$i^ii_dk3)(#q#qw+c5msshvdb6_h')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', 'True').lower() == 'true'

ALLOWED_HOSTS = ['*']  # For simplicity in deployment
...
# Increase upload size limits for screenshot data
